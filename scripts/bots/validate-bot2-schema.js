...
const schemaPath = path.join(root, ".github/bots/schemas/bot2-writer-output.schema.json");
const successPath = path.join(root, ".github/bots/examples/bot2-success.json");
const blockedPath = path.join(root, ".github/bots/examples/bot2-blocked.json");
