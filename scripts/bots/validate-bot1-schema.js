...
const schemaPath = path.join(root, ".github/bots/schemas/bot1-ingestion-output.schema.json");
const successPath = path.join(root, ".github/bots/examples/bot1-success.json");
const blockedPath = path.join(root, ".github/bots/examples/bot1-blocked.json");
